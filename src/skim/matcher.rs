...
use crate::skim::item::{ItemPool, MatchedItem};
use crate::skim::spinlock::SpinLock;
use crate::skim::{CaseMatching, MatchEngineFactory};
...
impl Matcher {
    ...
    {
        let matcher_engine = self
            .engine_factory
            .create_engine_with_case(query, self.case_matching);
